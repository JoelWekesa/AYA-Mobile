...
import 'dart:io';
import 'package:aya2/helpers/utils.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildSupplierAddress(NCK supplier) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: 'MPESA', value: invoice.supplier.paymentInfo),
        ],
      );
