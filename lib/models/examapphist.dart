...
List<ExamAppHistory> ExamAppHistoryFromJson(String str) =>
    List<ExamAppHistory>.from(
        json.decode(str).map((x) => ExamAppHistory.fromJson(x)));

String examHistToJson(List<ExamAppHistory> data) =>
...
class ExamAppHistory {
  ...
  factory ExamAppHistory.fromJson(Map<String, dynamic> json) => ExamAppHistory(
